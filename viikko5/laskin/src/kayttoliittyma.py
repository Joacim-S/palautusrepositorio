...
class Kayttoliittyma:
    ...
    def _suorita_komento(self, komento):
        ...
        self._arvo_var.set(self._sovelluslogiikka.arvo())
        self._komennot[Komento.KUMOA].edellinen(komento_olio)
...
class Summa(BinaariOperaatio):
    ...
    def laske(self):
        self.edellinen = self.logiikka.arvo()
...
class Kumoa(BinaariOperaatio):
    ...
    def suorita(self):
        self.edellinen_olio.kumoa()
        
    def edellinen(self, edellinen_olio):
        self.edellinen_olio = edellinen_olio